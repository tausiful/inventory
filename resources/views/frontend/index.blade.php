...
<head>
  ...
  <title>MNH Industries Ltd.</title>
...
<body>
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="/"><span>MNH</span></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h2>We are a family dedicated to fulfill the needs of yours. Our passion towards that goal has led us to become one of the largest and leading FMCG company in Bangladesh with exports to 13 countries around the world.</h2>
