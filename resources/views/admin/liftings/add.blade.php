...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="card-body">
       <form class="needs-validation" novalidate action="{{ route('lifting.store') }}" method="post">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="voucharNo" value="{{ old('voucharNo') }}" id="validationCustom01" required>
                        </div>
