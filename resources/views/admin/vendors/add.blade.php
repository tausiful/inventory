...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" novalidate action="{{ route('vendor.store') }}" method="post">
            	{{ csrf_field() }}
                <div class="form-row">
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" id="validationCustom03"  name="contact_person">
                        <div class="invalid-feedback">
                   ...
                   <div class="form-row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom03"  name="contact_number">
                            <div class="invalid-feedback">
