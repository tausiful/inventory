                ...
                <div class="form-row">
                   ...
                   <div class="form-row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom03"  name="model_no" required>
                            <div class="invalid-feedback">
                                Please provide a product name.
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="number" class="form-control" id="validationCustom03"  name="cost_price" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="number" class="form-control" id="validationCustom03"  name="mrp" required>
                            <div class="invalid-feedback">
