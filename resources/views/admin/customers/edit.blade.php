...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" novalidate action="{{ route('customer.update', ['id'=>$customer->id]) }}" method="post">
            	{{ csrf_field() }}
                <div class="form-row">
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                        <label for="validationCustom03">Customer Name</label>
                        <input type="text" class="form-control" id="validationCustom03"  name="name" value="{{$customer->name}}" required>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" id="validationCustom03"  name="code" value="{{$customer->code}}" readonly="" >
                        <div class="invalid-feedback">
                   ...
                   <div class="form-row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom03"  name="national_id" value="{{$customer->national_id}}">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom03"  name="phone"  value="{{$customer->phone}}">
                            <div class="invalid-feedback">
